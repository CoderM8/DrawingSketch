    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Spacer(),
            Image.asset("assets/png/camera_permission.png", color: whiteColor, height: 222.w, width: 222.w),
            SizedBox(height: 30.h),
            ConstText("${'Camera'.tr} ${"permission_needed".tr}", fontFamily: 'B', fontSize: 22.sp, color: whiteColor),
            SizedBox(height: 30.h),
            ConstText(
              "permission_camera",
              fontFamily: 'M',
            ...
            ConstButton(
              ...
              text: "Continue",
              onTap: () async {
                await Apis.requestPermission(context, type: PerType.Camera, isVisit: true);
              },
            ),
